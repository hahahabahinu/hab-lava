...
if [ $? -eq 0 ]; then
    ...
    echo "Ethereum Data: $eth_data" >> "$OUTPUT_DIR/ethereum-new.txt"
    echo "Runner IP: $runner_ip" >> "$OUTPUT_DIR/ethereum-new.txt"
    
    echo "Ethereum data fetched and saved to $OUTPUT_DIR/ethereum-new.txt."
else
